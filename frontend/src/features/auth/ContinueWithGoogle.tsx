...
export default function ContinueWithGoogle() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-indigo-950 dark:to-purple-950">
      {/* Navigation */}
      <nav className="w-full p-4 flex justify-between items-center">
        ...
        <div>
          <SignInButton mode="modal">
            <button className="px-4 py-2 rounded-full bg-white text-primary border border-primary hover:bg-primary hover:text-white transition-colors duration-300 shadow-sm">
              Log In
            </button>
          </SignInButton>
        </div>
      ...
      <main className="flex-1 flex flex-col md:flex-row items-center justify-center px-6 py-12 md:py-0 max-w-7xl mx-auto">
        <div className="md:w-1/2 space-y-6 text-center md:text-left mb-10 md:mb-0">
          ...
          <div className="pt-4">
            <SignInButton mode="modal">
              <button className="px-8 py-3 rounded-full bg-primary text-white hover:bg-primary/90 transition-colors duration-300 shadow-md text-lg font-medium">
                Get Started
              </button>
            </SignInButton>
          </div>
        ...
        <div className="md:w-1/2 flex justify-center">
          <div className="relative w-full max-w-md">
            ...
            <div className="absolute -bottom-4 -right-4 w-72 h-72 bg-indigo-400/10 rounded-full filter blur-3xl opacity-70"></div>
                ...
                <div className="flex gap-3 justify-end">
                  <div className="flex-1 flex flex-col items-end">
                    <div className="bg-primary p-3 rounded-2xl rounded-tr-none max-w-[80%]">
                      <p className="text-white">Thanks! This looks amazing!</p>
                    </div>
